...
A curated list of useful AI coding skills, tools, and workflows.

Mostly things that improve coding agents, reduce wasted tokens, provide better context, or make AI-assisted development easier.

<img src="./assets/star-full.svg" width="12" height="12" alt="Favorite"> marks tools I personally use or especially like.
...
- [Superpowers](https://github.com/obra/superpowers) — Structured software development workflow built from composable agent skills.
...
- <img src="./assets/star-full.svg" width="12" height="12" alt="Favorite"> [Codex](https://github.com/openai/codex) — OpenAI coding agent for terminal-based development.
...
- [Plannotator](https://github.com/backnotprop/plannotator) — Visual review interface for agent plans and code changes.
...
Open an issue or pull request if you know a useful AI coding skill, tool, or workflow that belongs here.

Keep descriptions short and link to the original project.
